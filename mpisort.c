...
/* Local functions */
void Generate_list(int local_A[], int local_n, int my_rank);  // II. generate locally
void Usage(char* program);   // proc 0 part of Get args
void Print_list(int local_A[], int local_n, int rank);  // Part of processor 0
void Merge_low(int local_A[], int temp_B[], int local_n);
void Merge_high(int local_A[], int temp_B[], int local_n);

int  Compare(const void* a_p, const void* b_p);

/* Functions involving communication */
void Get_args(int argc, char* argv[], int* global_n_p, int* local_n_p, // I. bcast values to others
         char* gi_p, int my_rank, int p, MPI_Comm comm);
void Sort(int local_A[], int local_n, int my_rank,   // IV. Parallel sort
         int p, MPI_Comm comm);
void Print_local_lists(int local_A[], int local_n,   // III. Receives local
         int my_rank, int p, MPI_Comm comm);
void Print_global_list(int local_A[], int local_n, int my_rank, // V. Print final answer
         int p, MPI_Comm comm);
 ...
 * Scratch:     temp_C
 */
void Merge_high(int local_A[], int temp_B[], 
        int local_n) {
   int ai, bi, ci;
